        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cinemas_Locations_BarangayId",
                        column: x => x.BarangayId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cinemas_Locations_CityId",
                        column: x => x.CityId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_Locations_BarangayId",
                        column: x => x.BarangayId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Users_Locations_CityId",
                        column: x => x.CityId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_Cinemas_CinemaId",
                        column: x => x.CinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CompletedOrders_Cinemas_CinemaId",
                        column: x => x.CinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CompletedOrders_MovieSchedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "MovieSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompletedOrders_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_MovieSchedules_ScheduleId",
                        column: x => x.ScheduleId,
                        principalTable: "MovieSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Messages_SupportTickets_SupportTicketId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Snacks_Orders_OrderId1",
                        column: x => x.OrderId1,
                        principalTable: "Orders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CinemaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MovieScheduledId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TransactionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SnackStamps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SnackStamps_Cinemas_CinemaId",
                        column: x => x.CinemaId,
                        principalTable: "Cinemas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SnackStamps_MovieSchedules_MovieScheduledId",
                        column: x => x.MovieScheduledId,
                        principalTable: "MovieSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SnackStamps_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SnackStamps_Snacks_SnackId",
                        column: x => x.SnackId,
                        principalTable: "Snacks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SnackStamps_Transactions_TransactionId",
                        column: x => x.TransactionId,
                        principalTable: "Transactions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SnackStamps_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompletedOrders_CinemaId",
                table: "CompletedOrders",
                column: "CinemaId");

            migrationBuilder.CreateIndex(
                name: "IX_CompletedOrders_MovieId",
                table: "CompletedOrders",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_CompletedOrders_ScheduleId",
                table: "CompletedOrders",
                column: "ScheduleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_SupportTicketId",
                table: "Messages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Snacks_OrderId1",
                table: "Snacks",
                column: "OrderId1");

            migrationBuilder.CreateIndex(
                name: "IX_SnackStamps_CinemaId",
                table: "SnackStamps",
                column: "CinemaId");

            migrationBuilder.CreateIndex(
                name: "IX_SnackStamps_MovieId",
                table: "SnackStamps",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_SnackStamps_MovieScheduledId",
                table: "SnackStamps",
                column: "MovieScheduledId");

            migrationBuilder.CreateIndex(
                name: "IX_SnackStamps_SnackId",
                table: "SnackStamps",
                column: "SnackId");

            migrationBuilder.CreateIndex(
                name: "IX_SnackStamps_TransactionId",
                table: "SnackStamps",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_SnackStamps_UserId",
                table: "SnackStamps",
                column: "UserId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Addresses_Locations_CityId",
                table: "Addresses",
                column: "CityId",
                principalTable: "Locations",
                principalColumn: "Id",
