        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CinemasGuid = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CinemaId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SnackStamps = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BarangayId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    FavoriteMovies = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_CompletedOrders_CompletedOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovieScheduleId1 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    MovieScheduleId2 = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Seats_MovieSchedules_MovieScheduleId1",
                        column: x => x.MovieScheduleId1,
                        principalTable: "MovieSchedules",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Seats_MovieSchedules_MovieScheduleId2",
                        column: x => x.MovieScheduleId2,
                        principalTable: "MovieSchedules",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seats_MovieScheduleId1",
                table: "Seats",
                column: "MovieScheduleId1");

            migrationBuilder.CreateIndex(
                name: "IX_Seats_MovieScheduleId2",
                table: "Seats",
                column: "MovieScheduleId2");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_CompletedOrderId",
                table: "Tickets",
